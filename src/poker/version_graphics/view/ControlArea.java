...
public class ControlArea extends HBox{
    ...
    private WinnerLabel lblWinner = new WinnerLabel();
    ...
    public ControlArea() {
    	...
    	this.getChildren().addAll(lblDeck, lblWinner, spacer, btnShuffle, btnDeal);
    ...
    public void linkWinner(Player winner) {
    	lblWinner.setWinner(winner);
    }
}
